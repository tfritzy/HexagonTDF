...
//     {
//         this.hexes = new Biome?[width, height];
...
//                 hexes[x, y] = perlinValue < LandPerlinCutoff ? Biome.Grass : Biome.Water;
...
//     public Biome? GetHex(int x, int y)
//     {
//         if (x >= Width || x < 0)
//         {
//             return null;
...
//     public Biome? GetHex(Vector2Int pos)
//     {
...
//         for (int x = 0; x < Width; x++)
//         {
//             if (GetHex(x, 0).Value == Biome.Water)
//             {
...
//         this.OceanHex = Helpers.GetCongruentHexes(this, startingHex, (Vector2Int pos) => { return GetHex(pos.x, pos.y).Value == Biome.Water; });
...
//                 landGroups[i].First(),
//                 MainLandmass,
//                 (Vector2Int pos) => { return GetHex(pos).Value != Biome.Water; });
...
//             {
//                 if (GetHex(point).Value != Biome.Grass)
//                 {
//                     hexes[point.x, point.y] = Biome.Grass;
...
//         {
//             if (hexes[pos.x, pos.y] == Biome.Grass && pos.y > this.Height * .75f)
//             {
//                 topLandmass.Add(pos);
//             }
//         }
...
//         this.hexes[this.TrebuchetPos.x, this.TrebuchetPos.y] = Biome.Grass;
//         this.hexes[this.HeroPos.x, this.HeroPos.y] = Biome.Grass;
